...
相同源码的独立 debug 包已在 Xiaomi 14 Ultra / Android 15 完成启动、SQLite 重启读取、媒体接口输出及 N25 图纸 11 色 325 颗识别确认。此 Release 包尚未装机复验，同签名覆盖更新、系统选图及完整备份恢复/分享复验仍待完成；详见 [验收记录](../docs/acceptance/issues13-14/README.md)。这是开发阶段自用包，未合并 PR 或上架发行。
